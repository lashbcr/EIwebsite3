...
export const metadata: Metadata = {
  title: 'Privacy Policy — Enterprise Insight',
  description: 'How Enterprise Insight collects, uses, and protects your personal data.',
};
        ...
        <Container>
          <AnimatedSection className="text-center max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-lg text-slate-500 dark:text-slate-400 leading-relaxed">
              How we collect, use, and protect your personal data at Enterprise Insight.
            </p>
          </AnimatedSection>
        </Container>
      </section>
        ...
        <Container>
          <AnimatedSection className="text-sm text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
            <p>
              ...
              <a
                href="mailto:hello@enterpriseinsight.io"
                className="text-primary-500 hover:text-primary-400 transition-colors"
              >
