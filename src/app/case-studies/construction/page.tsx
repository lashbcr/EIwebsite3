...
export const metadata: Metadata = {
  title: 'Hercules PLS Case Study — Enterprise Insight',
  description: 'How Hercules PLS used Enterprise Insight to rationalise their application portfolio and transform their EA practice.',
};
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-white dark:bg-[#060b14] relative overflow-hidden">
        ...
        <Container>
          <AnimatedSection className="max-w-3xl mx-auto">
            ...
            <span className="text-xs font-medium text-slate-400 mb-4 block">Construction · Case Study</span>
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-slate-900 dark:text-white mb-4">
              How Hercules PLS transformed their EA practice with Enterprise Insight
            </h1>
            <p className="text-lg text-slate-500 dark:text-slate-400 leading-relaxed">
              From a fragmented application landscape to a streamlined, AI-powered architecture practice — in under six months.
            </p>
          </AnimatedSection>
        </Container>
      </section>
      ...
      <section className="py-12 bg-slate-50 dark:bg-[#080f1c] border-y border-slate-200 dark:border-white/6">
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-3xl mx-auto">
            {[
              { label: 'Apps rationalised', value: '40%' },
              { label: 'Review cycle time', value: '−80%' },
              { label: 'Stakeholders engaged', value: '200+' },
              { label: 'Time to first insight', value: '< 2 weeks' },
            ].map((stat, i) => (
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            <AnimatedSection>
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                [Detailed description of Hercules PLS's situation before Enterprise Insight — scattered architecture data, slow review processes, lack of stakeholder visibility, etc. To be filled in.]
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.05}>
              <div className="rounded-xl bg-slate-50 dark:bg-white/3 border border-slate-200 dark:border-white/8 p-6">
                <blockquote className="text-lg font-medium text-slate-700 dark:text-slate-200 leading-relaxed">
                  "[Customer quote placeholder — to be filled in with real quote from Hercules PLS stakeholder.]"
                </blockquote>
                <footer className="mt-4 text-sm text-slate-400">
                  — [Name], [Title], Hercules PLS
                </footer>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.1}>
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                [How Hercules PLS deployed and rolled out Enterprise Insight — which modules, integration approach, change management, etc. To be filled in.]
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.15}>
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                [Detailed outcomes — quantitative and qualitative. To be filled in.]
              </p>
            </AnimatedSection>
